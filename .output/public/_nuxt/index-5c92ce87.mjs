import{_ as k}from"./Logo-437dbd67.mjs";import{_ as C,d as L,z as h,o as r,e as F,w as B,m as E,a as e,s as c,b as M,c as d,r as v,F as _,R as f,T as b,p as S,h as T,g as i,t as w}from"./entry-98fe8681.mjs";import{H as j}from"./index-ed8b9815.mjs";import"./hooks-316cf43c.mjs";const A=`
...
`,H=L({name:"index",setup(o,{expose:m}){m();const p=h([{html:q,preview:!0},{html:A,preview:!0}]),s=a=>{const t=p.value[a];t.preview=!t.preview,t.preview||j.highlightBlock(document.querySelector("#pre-"+a))},x=h(0),g=a=>{n.value=a>150},n=h(!1),l={temps:p,showCode:s,curTemp:x,onChange:g,asideFixed:n};return Object.defineProperty(l,"__isScriptSetup",{enumerable:!1,value:!0}),l}}),u=o=>(S("data-v-61590247"),o=o(),T(),o),D={class:"main-content flex"},I={class:"p-2 h-min rounded-box"},O={class:"w-full lg:pr-10"},z={class:"menu bg-base-100 p-2 w-full h-min rounded-box"},N=u(()=>e("li",{class:"menu-title py-2"},[e("span",null,"List")],-1)),V=["onClick"],Z=["href"],P={class:"w-96 flex-shrink-0 opacity-0 hidden lg:flex"},J={class:"flex-1 relative overflow-hidden px-5 bg-base-100 py-10 rounded-box prose"},R=u(()=>e("h1",null,"Tailwind CSS - Card",-1)),K=u(()=>e("p",null,[i(" \u6536\u96C6\u7684\u4E00\u4E9B"),e("code",null,"Card"),i("\u6837\u5F0F\uFF0C\u6240\u6709\u7684\u6A21\u677F\u5747\u6539\u9020\u4E3A "),e("code",null,"DaisyUI"),i(" \u4E3B\u9898\u6837\u5F0F\uFF0C\u53EF\u4EE5\u5B8C\u7F8E\u652F\u6301\u4E3B\u9898\u5207\u6362\u3002 ")],-1)),Q=["id"],U=["onClick"],W=u(()=>e("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-6 w-6",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor","stroke-width":"2"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"})],-1)),G=[W],X=["innerHTML"],Y={class:"bg-base-200 px-4"},$=i("            "),ee=["id"],te=i(`
          `);function se(o,m,p,s,x,g){const n=k,l=E;return r(),F(l,{onChange:s.onChange},{default:B(()=>[e("main",D,[e("aside",{class:c([{fixed:s.asideFixed},"top-0 w-96 flex-shrink-0 max-h-screen hidden lg:flex flex-col z-10 "])},[e("section",{class:c(["w-full lg:pr-10 my-5",{hidden:!s.asideFixed}])},[e("div",I,[M(n)])],2),e("section",O,[e("ul",z,[N,(r(!0),d(_,null,v(s.temps,(a,t)=>(r(),d("li",{class:"text-xl",key:t,onClick:y=>s.curTemp=t},[e("a",{href:"#card-a"+t,class:c({active:s.curTemp===t,capitalize:s.curTemp===t})},w(t+1)+" . card ",11,Z)],8,V))),128))])])],2),f(e("aside",P,null,512),[[b,s.asideFixed]]),e("div",J,[R,K,(r(!0),d(_,null,v(s.temps,(a,t)=>(r(),d("div",{class:"mockup-window border bg-base-300 w-full mb-8",id:"card-a"+t,key:t},[e("div",{class:c(["btn btn-sm btn-square btn-primary absolute right-8 top-2 gap-2",{"btn-outline":a.preview}]),onClick:y=>s.showCode(t)},G,10,U),e("div",{class:"flex justify-center px-4 lg:pt-16 lg:pb-10 pt-8 pb-5 bg-base-200",innerHTML:a.html},null,8,X),f(e("pre",Y,[$,e("code",{id:"pre-"+t,class:"rounded-box"},w(a.html),9,ee),te],512),[[b,!a.preview]])],8,Q))),128))])])]),_:1})}var ne=C(H,[["render",se],["__scopeId","data-v-61590247"]]);export{ne as default};
