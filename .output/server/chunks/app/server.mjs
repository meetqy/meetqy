...
const _sfc_main$w = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "article-b" }, _attrs))} data-v-50e0733f><div class="tags relative z-10" data-v-50e0733f><a href="javascript:;" style="${serverRenderer.exports.ssrRenderStyle(`color: ${__props.tag.color};background-color: ${__props.tag.bgColor}`)}" data-v-50e0733f>${serverRenderer.exports.ssrInterpolate(__props.tag.name)}</a></div><header data-v-50e0733f>`);
            ...
            serverRenderer.exports.ssrRenderList(__props.headerImages, (item) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(SwiperSlide), { key: item }, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="bg-cover hover:bg-bottom transition-all duration-500 ease-linear delay-200" style="${serverRenderer.exports.ssrRenderStyle(`background-image:url(${vue_cjs_prod.unref($cdn) + item});height: 225px`)}" data-v-50e0733f${_scopeId2}></div>`);
                  } else {
                    return [
      ...
      _push(`<div class="flex justify-center mt-5 flex-col items-center" data-v-50e0733f><time class="flex items-center capitalize" data-v-50e0733f><i class="text-2xl iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8B4</i><span class="ml-2 text-sm" data-v-50e0733f>${serverRenderer.exports.ssrInterpolate(__props.time)}</span></time></div></header><main class="text-center px-4" data-v-50e0733f><h1 class="title py-2 text-center" data-v-50e0733f>`);
      ...
      _push(`</h1><p class="text-opacity-60 text-black font-light text-center" data-v-50e0733f>${serverRenderer.exports.ssrInterpolate(__props.desciption)}</p></main><footer class="flex justify-between items-center mt-10" data-v-50e0733f><a href="javascript:;" class="flex items-center" data-v-50e0733f><span class="author-image" style="${serverRenderer.exports.ssrRenderStyle({ "background-image": "url('/avatar.jpg')" })}" data-v-50e0733f></span><span class="author-name" data-v-50e0733f>meetqy</span></a><div class="text-sm text-black text-opacity-60" data-v-50e0733f><a href="javascript:;" data-v-50e0733f><span class="mr-1" data-v-50e0733f>${serverRenderer.exports.ssrInterpolate(__props.visit)}</span><i class="iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8F4</i></a><a href="javascript:;" class="ml-4" data-v-50e0733f><span class="mr-1" data-v-50e0733f>${serverRenderer.exports.ssrInterpolate(__props.comment)}</span><i class="iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8B5</i></a></div></footer></article>`);
    };
  }
});
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["__scopeId", "data-v-50e0733f"]]);
const _sfc_main$v = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="bg-black pt-10 rounded-2xl bg-opacity-60"><div class="tags"><a href="javascript:;">${serverRenderer.exports.ssrInterpolate(__props.tag)}</a></div><header class="relative flex justify-center items-center flex-col px-4"><time class="flex items-center text-white capitalize"><i class="text-2xl iconfont">\uE8B4</i><span class="ml-2 text-sm">${serverRenderer.exports.ssrInterpolate(__props.time)}</span></time></header><main class="text-white text-center px-4"><h1 class="title py-2">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
      ...
      _push(`</h1><p class="text-opacity-60">${serverRenderer.exports.ssrInterpolate(__props.desciption)}</p></main><footer class="flex justify-between items-center mt-10"><a href="javascript:;" class="flex items-center"><span class="author-image" style="${serverRenderer.exports.ssrRenderStyle({ "background-image": "url('/avatar.jpg')" })}"></span><span class="author-name">meetqy</span></a><div class="text-white text-sm"><a href="javascript:;"><span class="mr-1">23719</span><i class="iconfont">\uE8F4</i></a><a href="javascript:;" class="ml-4"><span class="mr-1">23719</span><i class="iconfont">\uE8B5</i></a></div></footer></div></article>`);
    };
  }
});
...
const _sfc_main$t = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex items-end" }, _attrs))} data-v-73662c7c><div class="flex items-center cursor-pointer logo" data-v-73662c7c><div class="w-12 h-12 rounded-full transition-all flex items-center justify-center" data-v-73662c7c>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_W, { size: 30 }, null, _parent));
      _push(`</div><div class="h-12 text-2xl uppercase inline-flex items-center px-2 rounded-full" data-v-73662c7c><span class="font-serif font-semibold" data-v-73662c7c>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(cao))} `);
      if (props.showWeek) {
      ...
      _push(`</span></div></div>`);
      if (props.showWeek) {
        _push(`<div class="inline-flex h-12 items-center text-white text-2xl" data-v-73662c7c><span class="text-yellow-400" data-v-73662c7c>\u4ECA\u5929\u661F\u671F${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(week))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, vue_cjs_prod.mergeProps({ onChange }, _attrs), {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<main class="main-content flex" data-v-0d302d04${_scopeId}><aside class="${serverRenderer.exports.ssrRenderClass([
              { fixed: asideFixed.value },
              "top-0 w-96 flex-shrink-0 max-h-screen hidden lg:flex flex-col z-10 "
            ])}" data-v-0d302d04${_scopeId}><section class="${serverRenderer.exports.ssrRenderClass([{ hidden: !asideFixed.value }, "w-full lg:pr-10 my-5"])}" data-v-0d302d04${_scopeId}><div class="p-2 h-min rounded-box" data-v-0d302d04${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_Logo, null, null, _parent2, _scopeId));
            _push2(`</div></section><section class="w-full lg:pr-10" data-v-0d302d04${_scopeId}><ul class="menu bg-base-100 p-2 w-full h-min rounded-box" data-v-0d302d04${_scopeId}><li class="menu-title py-2" data-v-0d302d04${_scopeId}><span data-v-0d302d04${_scopeId}>List</span></li><!--[-->`);
            serverRenderer.exports.ssrRenderList(temps.value, (item, index2) => {
              _push2(`<li class="text-xl" data-v-0d302d04${_scopeId}><a${serverRenderer.exports.ssrRenderAttr("href", "#card-a" + index2)} class="${serverRenderer.exports.ssrRenderClass({
                active: curTemp.value === index2,
                capitalize: curTemp.value === index2
              })}" data-v-0d302d04${_scopeId}>${serverRenderer.exports.ssrInterpolate(index2 + 1)} . card </a></li>`);
            });
            _push2(`<!--]--></ul></section></aside><aside class="w-96 flex-shrink-0 opacity-0 hidden lg:flex" style="${serverRenderer.exports.ssrRenderStyle(asideFixed.value ? null : { display: "none" })}" data-v-0d302d04${_scopeId}></aside><div class="flex-1 relative overflow-hidden px-5 bg-base-100 py-10 rounded-box prose" data-v-0d302d04${_scopeId}><h1 data-v-0d302d04${_scopeId}>Tailwind CSS - Card</h1><p data-v-0d302d04${_scopeId}> \u6536\u96C6\u7684\u4E00\u4E9B<code data-v-0d302d04${_scopeId}>Card</code>\u6837\u5F0F\uFF0C\u6240\u6709\u7684\u6A21\u677F\u5747\u6539\u9020\u4E3A <code data-v-0d302d04${_scopeId}>DaisyUI</code> \u4E3B\u9898\u6837\u5F0F\uFF0C\u53EF\u4EE5\u5B8C\u7F8E\u652F\u6301\u4E3B\u9898\u5207\u6362\u3002 </p><!--[-->`);
            serverRenderer.exports.ssrRenderList(temps.value, (item, index2) => {
              _push2(`<div class="mockup-window border bg-base-300 w-full mb-8"${serverRenderer.exports.ssrRenderAttr("id", "card-a" + index2)} data-v-0d302d04${_scopeId}><div class="${serverRenderer.exports.ssrRenderClass([{ "btn-outline": item.preview }, "btn btn-sm btn-square btn-primary absolute right-8 top-2 gap-2"])}" data-v-0d302d04${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-0d302d04${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" data-v-0d302d04${_scopeId}></path></svg></div><div class="flex justify-center px-4 lg:pt-16 lg:pb-10 pt-8 pb-5 bg-base-200" data-v-0d302d04${_scopeId}>${item.html}</div><pre class="bg-base-200 px-4" style="${serverRenderer.exports.ssrRenderStyle(!item.preview ? null : { display: "none" })}" data-v-0d302d04${_scopeId}>            <code class="rounded-box" data-v-0d302d04${_scopeId}>${serverRenderer.exports.ssrInterpolate(item.html)}</code>
          </pre></div>`);
            });
            _push2(`<!--]--></div></main>`);
          } else {
            return [
              vue_cjs_prod.createVNode("main", { class: "main-content flex" }, [
                vue_cjs_prod.createVNode("aside", {
                  ...
                  vue_cjs_prod.createVNode("section", { class: "w-full lg:pr-10" }, [
                    vue_cjs_prod.createVNode("ul", { class: "menu bg-base-100 p-2 w-full h-min rounded-box" }, [
                      ...
                      (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(temps.value, (item, index2) => {
                        return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("li", {
                          ...
                          }, vue_cjs_prod.toDisplayString(index2 + 1) + " . card ", 11, ["href"])
                        ], 8, ["onClick"]);
                      }), 128))
                    ])
                  ])
                ...
                vue_cjs_prod.createVNode("div", { class: "flex-1 relative overflow-hidden px-5 bg-base-100 py-10 rounded-box prose" }, [
                  ...
                  (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(temps.value, (item, index2) => {
                    return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                      ...
                      vue_cjs_prod.createVNode("div", {
                        ...
                        onClick: ($event) => item.preview = !item.preview
                      }, [
                      ...
                      vue_cjs_prod.withDirectives(vue_cjs_prod.createVNode("pre", { class: "bg-base-200 px-4" }, [
                        ...
                        vue_cjs_prod.createVNode("code", { class: "rounded-box" }, vue_cjs_prod.toDisplayString(item.html), 1),
                        vue_cjs_prod.createTextVNode("\n          ")
                      ], 512), [
                        [vue_cjs_prod.vShow, !item.preview]
                      ])
                    ], 8, ["id"]);
                  }), 128))
                ])
...
const routes = [
  ...
  },
  {
    name: "template",
    path: "/template",
    file: "/Users/meetqy/Desktop/my-template/nuxt-wcao.cc/pages/template/index.vue",
    children: [],
    meta: meta$9,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext = {}) {
    ...
    vueApp.component("App", _sfc_main$g);
...
const _sfc_main$e = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="${serverRenderer.exports.ssrRenderClass([{ "mt-4": __props.showLogo }, "text-black text-opacity-70 text-sm"])}"> Copyright \xA9 2022 wcao.cc </p></footer>`);
    };
  }
});
...
const _sfc_main$d = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Footer = _sfc_main$e;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        id: "container",
        ref_key: "el",
        ref: el
      }, _attrs))}><div class="container lg:max-w-full xl:container mx-auto p-6">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Header, { class: "border-b-2 border-white border-opacity-25 py-8" }, null, _parent));
      serverRenderer.exports.ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
...
const tools = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$2]]);
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            serverRenderer.exports.ssrRenderList([
              ...
              _push2(`<a href="javascript:;" class="${serverRenderer.exports.ssrRenderClass([item, "px-4 py-2 text-white rounded-full mr-2 mb-4"])}" data-v-2ad854f4${_scopeId}> Astronomy </a>`);
            });
            _push2(`<!--]--></div></div><div data-v-2ad854f4${_scopeId}><p class="bottom-title" data-v-2ad854f4${_scopeId}>\u5173\u4E8E\u6211</p><div class="mt-5" data-v-2ad854f4${_scopeId}><div class="flex" data-v-2ad854f4${_scopeId}><img class="w-24 h-24 rounded-full border-4 border-cyan-500"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="meetqy" data-v-2ad854f4${_scopeId}><div class="ml-5 flex flex-col justify-center" data-v-2ad854f4${_scopeId}><p class="text-lg font-semibold text-white" data-v-2ad854f4${_scopeId}> meetqy <sup class="inline-block line-through decoration-red-500 decoration-4" data-v-2ad854f4${_scopeId}> \u90FD${serverRenderer.exports.ssrInterpolate(new Date().getFullYear() - 1996)}\u4E86 </sup></p><p class="text-white text-opacity-70 text-sm my-1" data-v-2ad854f4${_scopeId}> \u524D\u7AEFCV\u5DE5\u7A0B\u5E08 - \u64C5\u957FCV\u5927\u6CD5 </p></div></div><p class="text-white mt-5 text-base text-opacity-90" data-v-2ad854f4${_scopeId}> \u6478\u9C7C\u3001\u517B\u72D7\u3001\u5E72\u996D\u3001\u627E\u6A21\u677F\u3001\u5199\u6A21\u677F\uFF0C\u751F\u6D3B\u5C31\u662F\u5982\u6B64\u7684\u6734\u5B9E\u65E0\u534E\uFF01 </p><p class="mt-4 about" data-v-2ad854f4${_scopeId}><span class="tag sm !text-black uppercase" style="${serverRenderer.exports.ssrRenderStyle({ "background-color": "#e5d836" })}" data-v-2ad854f4${_scopeId}> js </span><span class="tag sm uppercase" style="${serverRenderer.exports.ssrRenderStyle({ "background-color": "#4266bb" })}" data-v-2ad854f4${_scopeId}> ts </span><span class="tag sm capitalize" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(to bottom right, #69bcf0, #28468a)" })}" data-v-2ad854f4${_scopeId}> flutter </span><span class="tag sm capitalize" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(to bottom right, #8bb840, #35362d)" })}" data-v-2ad854f4${_scopeId}>node </span><span class="tag sm shadow !text-black" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(to bottom right, #4ea1c5, #55b3a8)" })}" data-v-2ad854f4${_scopeId}> Tailwind CSS </span><span class="tag sm shadow" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(to bottom right, #c15029, #cf642d)" })}" data-v-2ad854f4${_scopeId}> HTML </span><span class="tag sm shadow" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(to bottom right, #335ca4, #5697de)" })}" data-v-2ad854f4${_scopeId}> CSS </span></p></div></div></div>`);
          } else {
            return [
              vue_cjs_prod.unref(posts) ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                ...
                (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(vue_cjs_prod.unref(posts), (post) => {
                  return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                    ...
                    getCategory(post).name === "\u6A21\u677F" ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_grid_item_b, {
                      key: 0,
                      title: post.attributes.title,
                      desciption: post.attributes.desciption,
                      time: post.attributes.updatedAt.split("T")[0],
                      ...
                      id: post.id + "",
                      to: post.attributes.to
                    }, null, 8, ["title", "desciption", "time", "visit", "comment", "tag", "header-images", "id", "to"])) : vue_cjs_prod.createCommentVNode("", true),
                    getCategory(post).name === "\u5DE5\u5177" ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_grid_item_a, {
                      ...
                      "header-images": getHeaderImages(post),
                      link: post.attributes.link
                    }, null, 8, ["title", "desciption", "time", "tag", "header-images", "link"])) : vue_cjs_prod.createCommentVNode("", true)
                  ]);
                }), 128))
                    ...
                    (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(3, (item) => {
                      return vue_cjs_prod.createVNode("li", { class: "flex mt-5" }, [
                        ...
                        vue_cjs_prod.createVNode("div", { class: "flex flex-col justify-center ml-5" }, [
                          vue_cjs_prod.createVNode("span", { class: "text-sm text-white text-opacity-50" }, "June 5, 2019"),
                          vue_cjs_prod.createVNode("p", { class: "text-base font-semibold text-white" }, " Mars is the fourth planet from the Sun ")
                        ])
                      ]);
                    }), 64))
                  ])
                  ...
                  vue_cjs_prod.createVNode("div", { class: "mt-5" }, [
                    vue_cjs_prod.createVNode("div", { class: "flex" }, [
                      ...
                      vue_cjs_prod.createVNode("div", { class: "ml-5 flex flex-col justify-center" }, [
                        vue_cjs_prod.createVNode("p", { class: "text-lg font-semibold text-white" }, [
                        ...
                        vue_cjs_prod.createVNode("p", { class: "text-white text-opacity-70 text-sm my-1" }, " \u524D\u7AEFCV\u5DE5\u7A0B\u5E08 - \u64C5\u957FCV\u5927\u6CD5 ")
                      ])
                    ]),
                    vue_cjs_prod.createVNode("p", { class: "text-white mt-5 text-base text-opacity-90" }, " \u6478\u9C7C\u3001\u517B\u72D7\u3001\u5E72\u996D\u3001\u627E\u6A21\u677F\u3001\u5199\u6A21\u677F\uFF0C\u751F\u6D3B\u5C31\u662F\u5982\u6B64\u7684\u6734\u5B9E\u65E0\u534E\uFF01 "),
...
const index$a = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-2ad854f4"]]);
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, vue_cjs_prod.mergeProps({ onChange }, _attrs), {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></ul></section></aside><aside class="w-96 opacity-0 hidden lg:flex" style="${serverRenderer.exports.ssrRenderStyle(asideFixed.value ? null : { display: "none" })}"${_scopeId}></aside><div class="flex-1 relative overflow-hidden p-5 bg-base-100 rounded-md prose prose-neutral prose-a:text-blue-500"${_scopeId}>`);
            ...
            _push2(`<div class="flex items-center mt-6 flex-wrap"${_scopeId}><a href="javascript:;" class="flex items-center justify-center"${_scopeId}><img class="w-8 h-8 rounded-full relative -top-0.5" style="${serverRenderer.exports.ssrRenderStyle({ "box-shadow": "2px 2px 5px 1px rgb(0 0 0 / 20%)" })}"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)}${_scopeId}><span class="ml-3"${_scopeId}> meetqy </span></a><a href="javascript:;" class="ml-6"${_scopeId}><i class="iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}"${_scopeId}>\uE8B4</i><span class="ml-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(post).updatedAt.split("T")[0])}</span></a><a href="javascript:;" class="ml-6"${_scopeId}><i class="iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}"${_scopeId}>\uE8F4</i><span class="ml-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(post).visit)}</span></a><a href="javascript:;" class="ml-6"${_scopeId}><i class="iconfont" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#e84e89" })}"${_scopeId}>\uE8B5</i><span class="ml-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(post).comment)}</span></a></div><article class="prose prose-neutral prose-a:text-blue-500 break-words"${_scopeId}>${vue_cjs_prod.unref(content)}</article><div class="py-16 mt-12 flex justify-center items-center flex-wrap" style="${serverRenderer.exports.ssrRenderStyle({ "border-top": "1px solid #f4f4f4", "border-bottom": "1px solid #f4f4f4" })}"${_scopeId}><span class="text-lg font-semibold mr-4"${_scopeId}>Link:</span><a${serverRenderer.exports.ssrRenderAttr("href", vue_cjs_prod.unref(post).link)} class="underline text-blue-500 break-words inline-block w-full text-center md:w-auto"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(post).link)}</a></div></div></main>`);
          } else {
            return [
              vue_cjs_prod.createVNode("main", { class: "main-content flex" }, [
                vue_cjs_prod.createVNode("aside", {
                ...
                vue_cjs_prod.createVNode("div", { class: "flex-1 relative overflow-hidden p-5 bg-base-100 rounded-md prose prose-neutral prose-a:text-blue-500" }, [
                  ...
                  vue_cjs_prod.createVNode("div", { class: "flex items-center mt-6 flex-wrap" }, [
                    vue_cjs_prod.createVNode("a", {
                      href: "javascript:;",
...
const index$8 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-0d302d04"]]);
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          vue_cjs_prod.createTextVNode(" 13")
        ];
      }
    }),
    _: 1
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/template/index.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const index$6 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(types), (item) => {
              _push2(`<article${_scopeId}><h2${serverRenderer.exports.ssrRenderAttr("id", item.name)} class="capitalize flex justify-between"${_scopeId}><span${_scopeId}><small class="text-gray-400"${_scopeId}># </small>${serverRenderer.exports.ssrInterpolate(item.name)}</span>`);
              if (item.link) {
            ...
            return [
              vue_cjs_prod.createVNode("main", { class: "main-content flex" }, [
                ...
                vue_cjs_prod.createVNode("div", { class: "flex-1 px-5 py-10 bg-white rounded-md prose prose-neutral prose-a:text-blue-500" }, [
                    ...
                    return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("article", null, [
                      vue_cjs_prod.createVNode("h2", {
                        ...
                        vue_cjs_prod.createVNode("span", null, [
                          vue_cjs_prod.createVNode("small", { class: "text-gray-400" }, "# "),
                          vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(item.name), 1)
                        ]),
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, vue_cjs_prod.mergeProps({ name: "tools" }, _attrs), {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            serverRenderer.exports.ssrRenderList(opts, (item, index2) => {
              _push2(`<option${serverRenderer.exports.ssrRenderAttr("value", item)}${_scopeId}> \u89E3\u6790\u7EBF\u8DEF ${serverRenderer.exports.ssrInterpolate(index2 + 1)}</option>`);
            });
            ...
            return [
              vue_cjs_prod.createVNode("div", { class: "container h-full m-auto px-32 flex flex-col" }, [
                vue_cjs_prod.createVNode("div", { class: "px-8 bg-black bg-opacity-25 rounded-md py-4" }, [
                  vue_cjs_prod.createVNode("div", { class: "w-48" }, [
                    vue_cjs_prod.createVNode("select", { class: "p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" }, [
                      vue_cjs_prod.createVNode("option", {
                        selected: "",
                        disabled: ""
                      }, "\u9009\u62E9\u7EBF\u8DEF"),
                      (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(opts, (item, index2) => {
                        return vue_cjs_prod.createVNode("option", { value: item }, " \u89E3\u6790\u7EBF\u8DEF " + vue_cjs_prod.toDisplayString(index2 + 1), 9, ["value"]);
                      }), 64))
                    ])
                  ])
                ]),
