...
const useAssetUrl = (url, query = ["f_webp"]) => `https://strapi.wcao.cc/uploads/${query.join(",")}${url.replace(/\/uploads/, "")}`;
const useTitle = () => {
...
const _sfc_main$x = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "relative flex flex-col justify-center bg-base-200 pt-4 rounded-lg shadow-md" }, _attrs))} data-v-35d27d4e><div class="w-full z-40 bg-top px-4 cursor-pointer" data-v-35d27d4e><div class="max-h-[600px] min-h-[200px] w-full rounded-box relative" data-v-35d27d4e><picture data-v-35d27d4e>`);
      if (vue_cjs_prod.unref(dark)) {
        _push(`<source preload${serverRenderer.exports.ssrRenderAttr("data-srcset", useAssetUrl(vue_cjs_prod.unref(dark).attributes.url, ["f_webp", "w_500"]))} media="(prefers-color-scheme: dark)" data-v-35d27d4e>`);
      } else {
        _push(`<!---->`);
      }
      if (vue_cjs_prod.unref(light)) {
        _push(`<source preload${serverRenderer.exports.ssrRenderAttr("data-srcset", useAssetUrl(vue_cjs_prod.unref(light).attributes.url, ["f_webp", "w_500"]))} media="(prefers-color-scheme: light)" data-v-35d27d4e>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<img${serverRenderer.exports.ssrRenderAttr("alt", __props.post.title)} class="lazy" preload${serverRenderer.exports.ssrRenderAttr("data-src", useAssetUrl(vue_cjs_prod.unref(light).attributes.url, ["f_webp", "w_500"]))} data-v-35d27d4e></picture></div></div>`);
      if (!__props.post.to) {
        _push(`<div class="absolute pt-10 rounded-lg left-0 top-0 z-30 w-full h-full cursor-pointer" data-v-35d27d4e><div class="tags" data-v-35d27d4e><a href="javascript:;" class="text-xs" style="${serverRenderer.exports.ssrRenderStyle(`color: ${__props.category.color};${__props.category.bgColor}`)}" data-v-35d27d4e> \u5B8C\u5584\u4E2D </a></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="w-full flex justify-between absolute left-0 top-0 -z-20" data-v-35d27d4e>`);
      ...
      _push(`</div><footer class="flex justify-between items-center relative z-50 py-4 px-4 bg-base-100 mt-4 rounded-b-lg" data-v-35d27d4e><div class="flex-1" data-v-35d27d4e><!--[-->`);
      ...
      _push(`<!--]--></div><div class="text-base-content text-sm" data-v-35d27d4e><a href="javascript:;" data-v-35d27d4e><span class="mr-1" data-v-35d27d4e>${serverRenderer.exports.ssrInterpolate(__props.post.visit || 1)}</span><i class="iconfont" data-v-35d27d4e>\uE8F4</i></a><a href="javascript:;" class="ml-4" data-v-35d27d4e><span class="mr-1" data-v-35d27d4e>${serverRenderer.exports.ssrInterpolate(__props.post.comment || 1)}</span><i class="iconfont" data-v-35d27d4e>\uE8B5</i></a></div></footer></article>`);
    };
  }
});
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-35d27d4e"]]);
const _sfc_main$w = {
  __name: "PostList",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "article-a",
        style: `background-image:url(${useAssetUrl(__props.headerImages[0], [
          "f_webp",
          "w_500"
        ])})`
      }, _attrs))} data-v-13ea95ea><div class="bg-base-100 pt-10 rounded-2xl bg-opacity-80" data-v-13ea95ea><div class="tags" data-v-13ea95ea>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
      ...
      _push(`</div><header class="relative flex justify-center items-center flex-col px-4" data-v-13ea95ea><time class="flex items-center text-base-content capitalize" data-v-13ea95ea><i class="text-2xl iconfont" data-v-13ea95ea>\uE8B4</i><span class="ml-2 text-sm" data-v-13ea95ea>${serverRenderer.exports.ssrInterpolate(__props.time)}</span></time></header><main class="text-base-content text-center px-4" data-v-13ea95ea><h1 class="title py-2" data-v-13ea95ea>`);
      ...
      _push(`</h1><p class="text-opacity-60" data-v-13ea95ea>${serverRenderer.exports.ssrInterpolate(__props.desciption)}</p></main><footer class="flex justify-between items-center mt-10" data-v-13ea95ea><a href="javascript:;" class="flex items-center" data-v-13ea95ea><span class="author-image" style="${serverRenderer.exports.ssrRenderStyle({ "background-image": "url('/avatar.jpg')" })}" data-v-13ea95ea></span><span class="author-name" data-v-13ea95ea>meetqy</span></a><div class="text-base-content text-sm" data-v-13ea95ea><a href="javascript:;" data-v-13ea95ea><span class="mr-1" data-v-13ea95ea>23719</span><i class="iconfont" data-v-13ea95ea>\uE8F4</i></a><a href="javascript:;" class="ml-4" data-v-13ea95ea><span class="mr-1" data-v-13ea95ea>23719</span><i class="iconfont" data-v-13ea95ea>\uE8B5</i></a></div></footer></div></article>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-13ea95ea"]]);
const _sfc_main$u = {
  __name: "ToolList",
  __ssrInlineRender: true,
  props: {
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-74dc3def"]]);
const meta$a = void 0;
const meta$9 = void 0;
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-94742796"]]);
const meta$8 = void 0;
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, vue_cjs_prod.mergeProps({ onChange }, _attrs), {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex"${_scopeId}><aside class="${serverRenderer.exports.ssrRenderClass([
              { fixed: asideFixed.value },
              "top-0 w-96 max-h-screen hidden lg:flex flex-col z-10 "
            ])}"${_scopeId}><section class="${serverRenderer.exports.ssrRenderClass([{ hidden: !asideFixed.value }, "w-full xl:mr-10 pr-5 my-5"])}"${_scopeId}><div class="p-2 h-min rounded-box"${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_Logo, null, null, _parent2, _scopeId));
            _push2(`</div></section><section class="w-full xl:mr-10 pr-4"${_scopeId}><ul class="menu bg-base-100 p-2 w-full rounded-box overflow-y-scroll h-96 scrollbar"${_scopeId}><li class="menu-title py-2"${_scopeId}><span${_scopeId}>Type</span></li><!--[-->`);
            ...
            _push2(`<!--]--></ul></section></aside><aside class="w-96 opacity-0 hidden lg:flex" style="${serverRenderer.exports.ssrRenderStyle(asideFixed.value ? null : { display: "none" })}"${_scopeId}></aside><div class="flex-1 max-w-full px-5 py-10 bg-base-100 rounded-md prose prose-neutral prose-a:text-blue-500"${_scopeId}><h1${_scopeId}>Random Image</h1><p${_scopeId}>`);
              ...
              vue_cjs_prod.createVNode("div", { class: "flex" }, [
                vue_cjs_prod.createVNode("aside", {
                  ...
                  vue_cjs_prod.createVNode("section", {
                    class: ["w-full xl:mr-10 pr-5 my-5", { hidden: !asideFixed.value }]
                  }, [
                    vue_cjs_prod.createVNode("div", { class: "p-2 h-min rounded-box" }, [
                      vue_cjs_prod.createVNode(_component_Logo)
                    ])
                  ], 2),
                  vue_cjs_prod.createVNode("section", { class: "w-full xl:mr-10 pr-4" }, [
                ...
                vue_cjs_prod.createVNode("div", { class: "flex-1 max-w-full px-5 py-10 bg-base-100 rounded-md prose prose-neutral prose-a:text-blue-500" }, [
