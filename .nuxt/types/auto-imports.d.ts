...
declare global {
  ...
  const useCdnUrl: typeof import('../../composables/hooks')['useCdnUrl']
  const useTitle: typeof import('../../composables/hooks')['useTitle']
  const useJsonToLanguage: typeof import('../../composables/jsonToLanguage')['useJsonToLanguage']
  const useJsonDefaultValue: typeof import('../../composables/jsonToLanguage')['useJsonDefaultValue']
  const allLanguage: typeof import('../../composables/jsonToLanguage')['allLanguage']
