...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "article-b" }, _attrs))} data-v-50e0733f><div class="tags relative z-10" data-v-50e0733f><a href="javascript:;" style="${ssrRenderStyle(`color: ${__props.tag.color};background-color: ${__props.tag.bgColor}`)}" data-v-50e0733f>${ssrInterpolate(__props.tag.name)}</a></div><header data-v-50e0733f>`);
            ...
            ssrRenderList(__props.headerImages, (item) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { key: item }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="bg-cover hover:bg-bottom transition-all duration-500 ease-linear delay-200" style="${ssrRenderStyle(`background-image:url(${unref($cdn) + item});height: 225px`)}" data-v-50e0733f${_scopeId2}></div>`);
                  } else {
                    return [
                      createVNode("div", {
      ...
      _push(`<div class="flex justify-center mt-5 flex-col items-center" data-v-50e0733f><time class="flex items-center capitalize" data-v-50e0733f><i class="text-2xl iconfont" style="${ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8B4</i><span class="ml-2 text-sm" data-v-50e0733f>${ssrInterpolate(__props.time)}</span></time></div></header><main class="text-center px-4" data-v-50e0733f><h1 class="title py-2 text-center" data-v-50e0733f>`);
      ...
      _push(`</h1><p class="text-opacity-60 text-black font-light text-center" data-v-50e0733f>${ssrInterpolate(__props.desciption)}</p></main><footer class="flex justify-between items-center mt-10" data-v-50e0733f><a href="javascript:;" class="flex items-center" data-v-50e0733f><span class="author-image" style="${ssrRenderStyle({ "background-image": "url('/avatar.jpg')" })}" data-v-50e0733f></span><span class="author-name" data-v-50e0733f>meetqy</span></a><div class="text-sm text-black text-opacity-60" data-v-50e0733f><a href="javascript:;" data-v-50e0733f><span class="mr-1" data-v-50e0733f>${ssrInterpolate(__props.visit)}</span><i class="iconfont" style="${ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8F4</i></a><a href="javascript:;" class="ml-4" data-v-50e0733f><span class="mr-1" data-v-50e0733f>${ssrInterpolate(__props.comment)}</span><i class="iconfont" style="${ssrRenderStyle({ "color": "#e84e89" })}" data-v-50e0733f>\uE8B5</i></a></div></footer></article>`);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ onChange }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<main class="main-content flex" data-v-0d302d04${_scopeId}><aside class="${ssrRenderClass([
              { fixed: asideFixed.value },
              "top-0 w-96 flex-shrink-0 max-h-screen hidden lg:flex flex-col z-10 "
            ])}" data-v-0d302d04${_scopeId}><section class="${ssrRenderClass([{ hidden: !asideFixed.value }, "w-full lg:pr-10 my-5"])}" data-v-0d302d04${_scopeId}><div class="p-2 h-min rounded-box" data-v-0d302d04${_scopeId}>`);
            ...
            ssrRenderList(temps.value, (item, index2) => {
              _push2(`<li class="text-xl" data-v-0d302d04${_scopeId}><a${ssrRenderAttr("href", "#card-a" + index2)} class="${ssrRenderClass({
                active: curTemp.value === index2,
                capitalize: curTemp.value === index2
              })}" data-v-0d302d04${_scopeId}>${ssrInterpolate(index2 + 1)} . card </a></li>`);
            });
            _push2(`<!--]--></ul></section></aside><aside class="w-96 flex-shrink-0 opacity-0 hidden lg:flex" style="${ssrRenderStyle(asideFixed.value ? null : { display: "none" })}" data-v-0d302d04${_scopeId}></aside><div class="flex-1 relative overflow-hidden px-5 bg-base-100 py-10 rounded-box prose" data-v-0d302d04${_scopeId}><h1 data-v-0d302d04${_scopeId}>Tailwind CSS - Card</h1><p data-v-0d302d04${_scopeId}> \u6536\u96C6\u7684\u4E00\u4E9B<code data-v-0d302d04${_scopeId}>Card</code>\u6837\u5F0F\uFF0C\u6240\u6709\u7684\u6A21\u677F\u5747\u6539\u9020\u4E3A <code data-v-0d302d04${_scopeId}>DaisyUI</code> \u4E3B\u9898\u6837\u5F0F\uFF0C\u53EF\u4EE5\u5B8C\u7F8E\u652F\u6301\u4E3B\u9898\u5207\u6362\u3002 </p><!--[-->`);
            ssrRenderList(temps.value, (item, index2) => {
              _push2(`<div class="mockup-window border bg-base-300 w-full mb-8"${ssrRenderAttr("id", "card-a" + index2)} data-v-0d302d04${_scopeId}><div class="${ssrRenderClass([{ "btn-outline": item.preview }, "btn btn-sm btn-square btn-primary absolute right-8 top-2 gap-2"])}" data-v-0d302d04${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-0d302d04${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" data-v-0d302d04${_scopeId}></path></svg></div><div class="flex justify-center px-4 lg:pt-16 lg:pb-10 pt-8 pb-5 bg-base-200" data-v-0d302d04${_scopeId}>${item.html}</div><pre class="bg-base-200 px-4" style="${ssrRenderStyle(!item.preview ? null : { display: "none" })}" data-v-0d302d04${_scopeId}>            <code class="rounded-box" data-v-0d302d04${_scopeId}>${ssrInterpolate(item.html)}</code>
          </pre></div>`);
            });
            _push2(`<!--]--></div></main>`);
          } else {
                  ...
                  (openBlock(true), createBlock(Fragment$1, null, renderList(temps.value, (item, index2) => {
                    return openBlock(), createBlock("div", {
                      ...
                      withDirectives(createVNode("pre", { class: "bg-base-200 px-4" }, [
                        createTextVNode("            "),
                        createVNode("code", { class: "rounded-box" }, toDisplayString$1(item.html), 1),
                        createTextVNode("\n          ")
                      ], 512), [
                        [vShow, !item.preview]
                      ])
